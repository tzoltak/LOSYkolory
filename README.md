...
5.  Funkcje pozwalające obliczać luminację kolorów i kontrast pomiędzy parami kolorów, zgodnie ze standardami WCAG 2.x i 3.x:

    -   `pick_more_contrasting()` - wybór kolorów jak najbardziej kontrastowych do podanych,
    -   `compute_apca_contrast()`, `compute_screen_luminance()` - kontrast i luminacja godnie ze standardem WCAG 2.x,
    -   `compute_contrast_ratio()`, `compute_relative_luminance()` - kontrast i luminacja godnie ze standardem WCAG 3.x.
